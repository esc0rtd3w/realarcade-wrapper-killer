@echo off
title RealArcade Wrapper Killer v%rawkver%    (.-+'~^-+ Update Mode +-^~`+-.)     [...cRypTiCwaRe 2o13...]
...
cls
inifile "%rawkroot%\servers.ini" [server1] url > "tmp_servers.bat"
::inifile "%rawkroot%\servers.ini" [server1] filepath >> "tmp_servers.bat"
::inifile "%rawkroot%\servers.ini" [server2] url >> "tmp_servers.bat"
::inifile "%rawkroot%\servers.ini" [server2] filepath >> "tmp_servers.bat"
call "tmp_servers.bat"
set server1=%url%
...
inifile "%rawkroot%\update\rawkdb.ini" [core] rdb_core > "rdb_core_available_ver.bat"
call "rdb_core_available_ver.bat"
set rdb_core_available=%rdb_core%

:rawkdb2
cls
inifile "%rawkroot%\rawkdb.ini" [core] rdb_core > "rdb_core_installed_ver.bat"
call "rdb_core_installed_ver.bat"
set rdb_core_installed=%rdb_core%

if %rdb_core_available%==0 goto rawkdb4

:rawkdb3
title RealArcade Wrapper Killer v%rawkver%    (.-+'~^-+ Update Info rawkdb.ini +-^~`+-.)     [...cRypTiCwaRe 2o13...]
cls
...
inifile "%rawkroot%\update\dlc.ini" [core] d_core > "d_core_available_ver.bat"
call "d_core_available_ver.bat"
set d_core_available=%d_core%

:dlc2
cls
inifile "%rawkroot%\dlc.ini" [core] d_core > "d_core_installed_ver.bat"
call "d_core_installed_ver.bat"
set d_core_installed=%d_core%

if %d_core_available%==0 goto dlc4

:dlc3
title RealArcade Wrapper Killer v%rawkver%    (.-+'~^-+ Update Info dlc.ini +-^~`+-.)     [...cRypTiCwaRe 2o13...]
cls
echo File: dlc.ini
echo.
echo.
...
inifile "%rawkroot%\update\patch.ini" [core] p_core > "p_core_available_ver.bat"
call "p_core_available_ver.bat"
set p_core_available=%p_core%

:patch2
cls
inifile "%rawkroot%\patch.ini" [core] p_core > "p_core_installed_ver.bat"
call "p_core_installed_ver.bat"
set p_core_installed=%p_core%

if %p_core_available%==0 goto patch4

:patch3
title RealArcade Wrapper Killer v%rawkver%    (.-+'~^-+ Update Info patch.ini +-^~`+-.)     [...cRypTiCwaRe 2o13...]
cls
echo File: patch.ini
echo.
echo.
...
inifile "%rawkroot%\update\rnarcade.ini" [core] rna_core > "rna_core_available_ver.bat"
call "rna_core_available_ver.bat"
set rna_core_available=%rna_core%

:rna2
cls
inifile "%rawkroot%\rnarcade.ini" [core] rna_core > "rna_core_installed_ver.bat"
call "rna_core_installed_ver.bat"
set rna_core_installed=%rna_core%

if %rna_core_available%==0 goto rna4

:rna3
title RealArcade Wrapper Killer v%rawkver%    (.-+'~^-+ Update Info rnarcade.ini +-^~`+-.)     [...cRypTiCwaRe 2o13...]
cls
...
inifile "%rawkroot%\update\servers.ini" [core] s_core > "s_core_available_ver.bat"
call "s_core_available_ver.bat"
set s_core_available=%s_core%

:servers2
cls
inifile "%rawkroot%\servers.ini" [core] s_core > "s_core_installed_ver.bat"
call "s_core_installed_ver.bat"
set s_core_installed=%s_core%

if %s_core_available%==0 goto servers4

:servers3
title RealArcade Wrapper Killer v%rawkver%    (.-+'~^-+ Update Info servers.ini +-^~`+-.)     [...cRypTiCwaRe 2o13...]
cls
...
inifile "%rawkroot%\update\stub.ini" [core] stub_core > "stub_core_available_ver.bat"
call "stub_core_available_ver.bat"
set stub_core_available=%stub_core%

:stub2
cls
inifile "%rawkroot%\stub.ini" [core] stub_core > "stub_core_installed_ver.bat"
call "stub_core_installed_ver.bat"
