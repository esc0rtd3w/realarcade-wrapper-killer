...
; *** Application titles
SetupAppTitle=cRypTiCwaRe Installer
SetupWindowTitle=%1 - cRypTiCwaRe Installer
UninstallAppTitle=unRealArcade Uninstaller
...
; *** "Welcome" wizard page
WelcomeLabel1=unRealArcade Setup Wizard
WelcomeLabel2=This will install [name] on your computer.%n%n.
...
FinishedHeadingLabel=[name] has been sucessfully installed.
FinishedLabelNoIcons=The unRealArcade Installer has finished installing [name] on your computer.
FinishedLabel=The unRealArcade Installer has finished installing [name] on your computer.%n%nThe game may be launched by selecting the installed icons.
