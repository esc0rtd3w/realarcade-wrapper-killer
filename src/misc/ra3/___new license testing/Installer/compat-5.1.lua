...
-- $Id: compat-5.1.lua,v 1.2.40.1 2009/11/10 20:15:34 jfouts Exp $
--
...
package.path = LUA_PATH or os.getenv("LUA_PATH") or (".\\?.lua;.\\socket\\?.lua")
 
package.cpath = LUA_CPATH or os.getenv("LUA_CPATH") or (".\\?.dll;.\\bin\\?.dll;.\\socket\\?.dll")
