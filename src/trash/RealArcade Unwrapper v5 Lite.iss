[Setup]
AppName=RealArcade Demo Unwrapper Lite v5.1.4
AppVerName=RealArcade Demo Unwrapper Lite v5.1.4
DefaultDirName=C:\My Games
OutputBaseFilename=RAWrapperKillerLite
OutputDir=C:\URA\rawk\_release\lite
