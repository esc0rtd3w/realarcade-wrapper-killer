@echo off
title RealArcade Wrapper Killer          (.-+'~^-+ GH Timer Reset +-^~`+-.)     [...cRypTiCwaRe 2o13...]
...
unlocker %file2% /s /d
taskkill /f /im unlocker.exe unlocker.exe
::del /s /q %file2%
...
:: Add current value to text file to see minutes values
echo %profileID% >> "%cd%\ghx_countdown.txt"
