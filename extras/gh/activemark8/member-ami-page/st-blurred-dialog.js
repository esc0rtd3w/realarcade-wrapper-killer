 ...
 * - Load popups from cached templates
 */
...
angular.module("stBlurredDialog",[])
	...
	.directive('stBlurredDialogOverlay', [function(){
		return {
			restrict: "E",			
			replace: true,
			template: 	"<div ng-if='model.isOpen' class='st-blurred-region-overlay' ng-click='close()'>" +
						"<div style='text-align:right;'><button ng-click='close()' class='st-blurred-region-close'>&#10006;</button></div>" +
					  	"<div ng-include=\"model.pathToTemplate\" ng-click='$event.stopPropagation()'></p>" +
						"</div>",
